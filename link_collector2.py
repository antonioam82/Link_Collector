...
class Collector:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Link Collector2")
    ...
    def copy_paste(self):
        messagebox.showinfo("COPY URL","Copy the URL or title you want.")
    ...
    def enter_name(self):
        ...
        entry_name = tk.Entry(self.window,width=22,font=('arial',20))
        entry_name.place(x=44,y=90)
        entry_name.focus()
        tk.Button(self.window,text="COPY",width=5,height=2,bg="gray77").place(x=378,y=90)
